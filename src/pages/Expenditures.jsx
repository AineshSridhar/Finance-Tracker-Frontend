    ...
    return (
      <div className="px-10">
        ...
        <div className="flex flex-row gap-10">
          ...
          {/* Summary Table */}
          <div className="w-1/4 border-4 border-blue-500 rounded-lg h-full">
            <h3 className="bg-blue-500 text-center py-4 text-white text-2xl">Summary</h3>
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left border-b">
                  <th className="px-2 py-3">Category</th>
                  <th className="px-2 py-3 text-right">% of Total</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-t font-bold">
                  ...
                  <td className="px-2 py-4 text-right">₹{grandTotal.toFixed(2)}</td>
                </tr>
              </tbody>
            </table>
          </div>
